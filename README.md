...
| VERTEX_PRIVATE_KEY | Description: The private key of the Google Cloud Vertex AI service account. Format: The value of the private_key field in the JSON string containing the service account private key information, please enclose the private key in double quotes. How to obtain: Create a service account in the Google Cloud Console, generate a JSON key file, and set its contents as the value of this environment variable. | No |
