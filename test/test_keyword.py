...
keyword_prompt = PromptTemplate(
    ...
    template="根据我的问题，提炼最少的关键词概括，用空格连接，不要出现其他符号，例如这个问题《How much does the 'zeabur' software service cost per month? Is it free to use? Any limitations?》，最小关键词是《zeabur price》，这是我的问题：{source}",
